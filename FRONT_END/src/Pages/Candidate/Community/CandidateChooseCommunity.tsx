...
// const socket = io('https://api.muflih.online/chat', { transports: ['websocket'] }); // Use correct server URL
const socket = io("https://api.muflih.online/chat", {
    path: "/chat/socket.io", // 👈 Important
});
