...
const InterviewerProfile = () => {
    ...
    const handleToSubmit = async (event: FormEvent) => {
        ...
        formData.append("email", interviewer.email);
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        {editMode.email ? (
                                            <input type="email" name="email" value={interviewer.email || ""} onChange={handleInputChange} className="p-1 rounded bg-[#4B4F60] text-white" />
                                        ) : (
                                            <p className="font-semibold mt-1 text-gray-300 text-sm">{interviewer.email || "Not Provided"}</p>
                                        )}
                                        {errors.email && (
                                            <p className="text-red-500 text-sm ml-10">{errors.email}</p>
                                        )}
                                    </div>
                                    <button type="button" onClick={() => handleEditClick("email")} className="text-white text-lg">
                                        {editMode.email ? <IoMdRemoveCircleOutline /> : <MdModeEditOutline />}
                                    </button>
                                </div>
