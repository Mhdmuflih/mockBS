...
import Interviewer_Route from "./Routes/interviewerRoute";
import Candidate_Route from "./Routes/candidateRoute";
...
app.listen(port, () => {
    console.log(`Review service Running on Ports: http://localhost:${port}`);
});
