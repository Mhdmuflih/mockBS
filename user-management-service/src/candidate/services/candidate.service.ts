...
export class CandidateService implements ICandidateService {
    ...
    async editProfileCandidate(userId: string, formData: ICandidate, file?: Express.Multer.File): Promise<void> {
        try {
            if (!formData || !userId) {
            ...
            await this.candidateRepository.updateCandidateData(userId, formData, fileName);
