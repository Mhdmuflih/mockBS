...
export class InterviewerRepository implements IInterviewerRepository {
    ...
    async updateInterviewerData(userId: string, formData: IInterviewer, fileName: string): Promise<any> {
        try {
            ...
            console.log(updateData, 'thsi is the update data')
            ...
            console.log(interviewer, 'this is the repository candidate')
